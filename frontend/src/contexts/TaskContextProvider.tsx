...
import { HighlightedText } from "../components/task/tasks.styled";
...
export const TaskContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [multipleSelectedTasks, setMultipleSelectedTasks] = useStorageState<
    UUID[]
  >([], "selectedTasks", "sessionStorage");
  const [search, setSearch] = useStorageState<string>(
    "",
    "search",
    "sessionStorage"
  );
